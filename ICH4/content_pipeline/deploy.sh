...
INDEX_SERVICE_URL="${INDEX_SERVICE_URL:-https://ich4-index-your-service-id-uc.a.run.app}"
TEMPLATE_SERVICE_URL="${TEMPLATE_SERVICE_URL:-}"
CLINICAL_ANALYST_SERVICE_URL="${CLINICAL_ANALYST_SERVICE_URL:-https://clinical-analyst-your-service-id-uc.a.run.app}"
